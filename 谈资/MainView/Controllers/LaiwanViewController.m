...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/22/0/10"
@interface LaiwanViewController ()

@end

@implementation LaiwanViewController {
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak LaiwanViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/22/%li/10",index];
