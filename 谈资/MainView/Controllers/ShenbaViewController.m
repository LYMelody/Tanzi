...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/19/0/10"

@interface ShenbaViewController ()

@end

@implementation ShenbaViewController {
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak ShenbaViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/19/%li/10",index];
