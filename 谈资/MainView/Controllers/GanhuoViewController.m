...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/20/0/10"
@interface GanhuoViewController ()

@end

@implementation GanhuoViewController{
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak GanhuoViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/20/%li/10",index];
