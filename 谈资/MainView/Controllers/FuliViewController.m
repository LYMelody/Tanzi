...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/28/0/10"
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak FuliViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/28/%li/10",index];
