...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/21/0/10"
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak GaoxiaoViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/21/%li/10",index];
