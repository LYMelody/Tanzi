...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/32/0/10"
@interface MengmengViewController ()

@end

@implementation MengmengViewController {
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak MengmengViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/32/%li/10",index];
