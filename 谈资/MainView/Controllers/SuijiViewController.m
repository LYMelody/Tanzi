...
#define Newsurl    @"http://mobile.itanzi.com/wap/api/NewsList/2/0/10"
@interface SuijiViewController ()
...
- (void)viewDidLoad {
    ...
    //上拉
    __weak SuijiViewController *weakSelf = self;
...
- (void)_loadMoreInfo {
    ...
    index += 1;
    Nexturl = [NSString stringWithFormat:@"http://mobile.itanzi.com/wap/api/NewsList/2/%li/10",index];
